...
$azureSpeechApiKey = azd env get-value AZURE_SPEECH_API_KEY
...
Add-Content -Path $envFilePath -Value "api_key=$azureSpeechApiKey"
Add-Content -Path $envFilePath -Value "region=$azureSpeechRegion"
